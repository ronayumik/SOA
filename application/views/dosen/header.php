    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        ...
        <div class="mdl-layout__header-row" style="background: hsl(0, 0%, 29.41176470588235%); color: white">
          ...
          <h1>
              ...
              <span class="mdl-layout-title" style="margin-top: 2px; font-size: 15px">Dosen</span>
          </h1>
          <?php } else { ?>
          <h1>
              <span class="mdl-layout-title" style="left: -50px">
                <!-- <a href="<?php echo base_url(); ?>index.php/tu/memilih_oprec"> -->
                  <button onclick="load_page('<?php echo base_url(); ?>index.php/dosen/memilih_oprec')" style="width: 40px; height: 40px; font-size: 32px" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">
          ...
          <span style="font-weight: 400"><?php echo $this->session->userdata('email'); ?></span>
      ...
      <div class="demo-drawer mdl-layout__drawer ">
        <nav class="demo-navigation mdl-navigation">
              ...
              <a class='mdl-navigation__link <?php if($menus) echo 'active' ?>' href='<?php echo base_url(); ?>index.php/dosen'>
                <i class=' material-icons' role='presentation'>home</i>Menus
              </a>
              <div class="mdl-menu__item--full-bleed-divider"></div>
              <a class='mdl-navigation__link <?php if($memilih) echo 'active' ?>' href='<?php echo base_url(); ?>index.php/dosen/memilih_oprec'>
                <i class=' material-icons' role='presentation'>today</i>Memilih Asisten
              </a>
