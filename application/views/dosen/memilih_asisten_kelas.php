		...
		<div class="mdl-cell mdl-cell--3-col mdl-shadow--2dp">
			<div class="mdl-grid" style="padding: 0">
				...
				<div class="mdl-cell mdl-cell--12-col" style="text-align: center; background: <?php echo $warna; ?>; min-height: 30px; width: 20%; margin: 0; font-size: 12px; padding-top: 3px; padding-bottom: 3px" >
                        ...
                        <div class="mdl-cell mdl-cell--12-col" style="text-align: center;background: <?php echo $warna; ?>; min-height: 30px; width: 20%; margin: 0; font-size: 12px; padding-top: 3px; padding-bottom: 3px" >
                          <?php if($ada_asisten) { ?>
                          	<button onclick="detail_asisten_pop('<?php echo $kelas['k_nrp_asisten']; ?>')" id="<?php echo $kelas['k_nrp_asisten']; ?>" style="width: 35px; height: 35px; font-size: 32px" class="mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon">                            
...
<script>
	...
	function detail_asisten_pop(id_asisten){
		$.ajax({
			type: "POST",
