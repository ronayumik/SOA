    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      ...
      <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
              <a class='mdl-navigation__link' href='<?php echo base_url(); ?>index.php/kaprodi/mengelola_oprec'>
                <i class='mdl-color-text--blue-grey-400 material-icons' role='presentation'>home</i>Oprec Asisten
              </a>
              <a class='mdl-navigation__link' href='<?php echo base_url(); ?>index.php/kaprodi/mengelola_pengumuman'>
                <i class='mdl-color-text--blue-grey-400 material-icons' role='presentation'>people</i>Pengumuman
              </a>
              <a class='mdl-navigation__link' href='<?php echo base_url(); ?>index.php/kaprodi/perekrutan_asisten'>
                <i class='mdl-color-text--blue-grey-400 material-icons' role='presentation'>people</i>Akun Dosen
              </a>
              <div class="mdl-layout-spacer"></div>
        </nav>
      </div>
